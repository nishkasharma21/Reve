...
import { Users, Sparkles, Shirt, Instagram, TrendingUp, Menu, X } from 'lucide-react';
...
export function Landing() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a1f] text-white overflow-x-hidden">
      {/* Navbar */}
      <nav className="fixed top-0 w-full z-50 bg-[#0a0a1f]/80 backdrop-blur-md border-b border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex justify-between items-center">
          ...
          <div className="hidden md:flex gap-6 items-center">
            ...
            <button 
              ...
              className="px-6 py-2 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full text-sm hover:opacity-90 transition-opacity"
            >
              Join Waitlist
            </button>
          </div>
        ...
        {/* Mobile Menu */}
        {mobileMenuOpen && (
          <div className="md:hidden bg-[#0a0a1f]/95 backdrop-blur-lg border-t border-white/5">
            <div className="px-4 py-6 space-y-4">
              ...
              <button 
                onClick={() => scrollToSection('waitlist')}
                className="block w-full px-4 py-3 bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg hover:opacity-90 transition-opacity text-center"
              >
                Join Waitlist
              </button>
            </div>
      ...
      <section id="waitlist" className="relative min-h-screen flex items-center justify-center pt-20 pb-12 overflow-hidden">
        ...
        <div className="absolute top-20 left-0 sm:left-10 w-64 sm:w-96 h-64 sm:h-96 bg-purple-500/30 rounded-full blur-3xl"></div>
        <div className="absolute bottom-20 right-0 sm:right-10 w-64 sm:w-96 h-64 sm:h-96 bg-cyan-500/30 rounded-full blur-3xl"></div>
        ...
        <div className="max-w-7xl w-full mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-8 lg:gap-12 items-center relative z-10">
          ...
          <div className="space-y-6 sm:space-y-8 w-full">
            <div className="inline-block px-3 sm:px-4 py-2 bg-purple-500/20 rounded-full text-xs sm:text-sm border border-purple-400/30">
            ...
            {status.type !== 'success' ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4 w-full max-w-md">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 w-full">
                    <input
                      ...
                      required
                      className="w-full sm:flex-1 px-4 sm:px-5 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder:text-gray-500 focus:outline-none focus:border-purple-400 transition-colors text-sm sm:text-base"
                    />
                    <input
                      type="text"
                      name="lastName"
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    required
                    className="w-full px-4 sm:px-5 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder:text-gray-500 focus:outline-none focus:border-purple-400 transition-colors text-sm sm:text-base"
                  />
                  
                  {/* Submit Button - Full width on mobile */}
                  <button
                    type="submit"
                    className="w-full px-8 py-3 bg-gradient-to-r from-purple-500 to-pink-500 rounded-xl font-semibold hover:opacity-90 transition-opacity text-sm sm:text-base"
                  >
                    Join Waitlist
                  </button>
                </form>
              ...
              <div className="w-full max-w-md p-5 sm:p-6 bg-gradient-to-r from-purple-500/20 to-pink-500/20 border border-purple-400/30 rounded-xl">
                <p className="text-base sm:text-lg font-semibold">✨ You're on the list!</p>
                <p className="text-sm sm:text-base text-gray-300 mt-2">We'll notify you when REVE launches at your campus.</p>
              </div>
            )}
            ...
            <div className="flex gap-6 sm:gap-8 pt-4 flex-wrap">
              <div>
                ...
                <div className="text-xs sm:text-sm text-gray-400">On Waitlist</div>
              </div>
              <div>
                <div className="text-2xl sm:text-3xl font-black">12</div>
                <div className="text-xs sm:text-sm text-gray-400">Campuses</div>
              </div>
              <div>
                <div className="text-2xl sm:text-3xl font-black bg-gradient-to-r from-purple-400 to-pink-400 text-transparent bg-clip-text">
                  Coming
                </div>
                <div className="text-xs sm:text-sm text-gray-400">Spring 2026</div>
              </div>
            </div>
          </div>
      ...
      <section className="relative h-64 sm:h-80 lg:h-[500px] w-full overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-purple-900/80 to-pink-900/80 flex items-center justify-center">
          <div className="text-center space-y-3 sm:space-y-4 px-4 sm:px-6">
            ...
            <p className="text-sm sm:text-lg lg:text-xl text-gray-200 max-w-2xl mx-auto">
      ...
      <section id="features" className="py-12 sm:py-16 lg:py-24 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10 sm:mb-16">
            ...
            <p className="text-base sm:text-lg lg:text-xl text-gray-400">Everything you need to become the fashion icon you are</p>
          </div>

          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {/* Feature 1 */}
            <div className="group relative bg-white/5 border border-white/10 rounded-3xl p-6 sm:p-8 hover:bg-white/10 transition-all duration-300">
            ...
            {/* Feature 3 */}
            <div className="group relative bg-white/5 border border-white/10 rounded-3xl p-6 sm:p-8 hover:bg-white/10 transition-all duration-300 sm:col-span-2 lg:col-span-1">
              <div className="absolute -top-6 left-6 sm:left-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            <div className="relative h-64 sm:h-80 lg:h-96 rounded-2xl overflow-hidden group">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end p-4 sm:p-6">
                <div>
                  <div className="font-black text-lg sm:text-xl mb-1">Share Your Fits</div>
            ...
            <div className="relative h-64 sm:h-80 lg:h-96 rounded-2xl overflow-hidden group">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end p-4 sm:p-6">
                <div>
                  <div className="font-black text-lg sm:text-xl mb-1">Discover Trends</div>
            ...
            <div className="relative h-64 sm:h-80 lg:h-96 rounded-2xl overflow-hidden group sm:col-span-2 lg:col-span-1">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end p-4 sm:p-6">
                <div>
                  <div className="font-black text-lg sm:text-xl mb-1">Organize Your Closet</div>
      ...
      <section id="about" className="py-12 sm:py-16 lg:py-24 relative">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center space-y-4 sm:space-y-6">
          <div className="inline-block px-3 sm:px-4 py-2 bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-full text-xs sm:text-sm border border-purple-400/30">
            💜 Why REVE?
          </div>
      ...
      <section className="py-12 sm:py-16 lg:py-24 relative">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center space-y-6 sm:space-y-8">
          ...
          <button 
            onClick={() => scrollToSection('waitlist')}
            className="w-full sm:w-auto px-10 sm:px-12 py-3 sm:py-4 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full text-base sm:text-lg font-semibold hover:opacity-90 transition-opacity"
          >
            Join the Waitlist
          </button>
        </div>
