...
export function Landing() {
  ...
  return (
    <div className={`min-h-screen bg-gray-50 text-gray-900 overflow-x-hidden transition-colors duration-300`}>
      {/* Navbar */}
      <nav className={`fixed top-0 w-full z-50 bg-white/80 backdrop-blur-md border-gray-200 border-b transition-colors duration-300`}>
        ...
        {/* Mobile Menu */}
        {mobileMenuOpen && (
          <div className={`md:hidden bg-white/95 backdrop-blur-lg border-gray-200 border-t transition-colors duration-300`}>
            <div className="px-4 py-6 space-y-4">
              <button 
                onClick={() => scrollToSection('about')}
                className={`block w-full text-left px-4 py-3 text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded-lg transition-colors`}
              >
                About
              </button>
              <button 
      ...
      <section id="waitlist" className="relative min-h-screen flex items-center justify-center pt-20 pb-12 overflow-hidden">
        ...
        <div className={`absolute top-20 left-0 sm:left-10 w-64 sm:w-96 h-64 sm:h-96 bg-purple-300/40 rounded-full blur-3xl transition-colors duration-300`}></div>
        <div className={`absolute bottom-20 right-0 sm:right-10 w-64 sm:w-96 h-64 sm:h-96 bg-cyan-300/40 rounded-full blur-3xl transition-colors duration-300`}></div>
        ...
        <div className="max-w-7xl w-full mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-8 lg:gap-12 items-center relative z-10">
          ...
          <div className="space-y-6 sm:space-y-8 w-full">
            <div className={`inline-block px-3 sm:px-4 py-2 bg-purple-100 border-purple-300 rounded-full text-xs sm:text-sm border transition-colors duration-300`}>
            ...
            <p className={`text-base sm:text-lg lg:text-xl text-gray-600 leading-relaxed max-w-xl transition-colors duration-300`}>
            ...
            {status.type !== 'success' ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4 w-full max-w-md">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 w-full">
                    <input
                      ...
                      required
                      className={`w-full sm:flex-1 px-4 sm:px-5 py-3 bg-white border-gray-300 text-gray-900 placeholder:text-gray-400 border rounded-xl focus:outline-none focus:border-purple-500 transition-colors text-sm sm:text-base`}
                    />
                    <input
                      type="text"
                      name="lastName"
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    required
                    className={`w-full px-4 sm:px-5 py-3 bg-white border-gray-300 text-gray-900 placeholder:text-gray-400 border rounded-xl focus:outline-none focus:border-purple-500 transition-colors text-sm sm:text-base`}
                  />
              ...
              <div className={`w-full max-w-md p-5 sm:p-6 bg-gradient-to-r from-purple-100 to-pink-100 border-purple-300 border rounded-xl transition-colors duration-300`}>
                <p className="text-base sm:text-lg font-semibold">✨ You're on the list!</p>
                <p className={`text-sm sm:text-base text-gray-600 mt-2 transition-colors duration-300`}>We'll notify you when REVE launches at your campus.</p>
              </div>
            )}
            ...
            <div className="flex gap-6 sm:gap-8 pt-4 flex-wrap">
              <div>
                ...
                <div className={`text-xs sm:text-sm text-gray-500 transition-colors duration-300`}>On Waitlist</div>
              </div>
              <div>
                <div className="text-2xl sm:text-3xl font-black">12</div>
                <div className={`text-xs sm:text-sm text-gray-500 transition-colors duration-300`}>Campuses</div>
              </div>
              <div>
                <div className="text-2xl sm:text-3xl font-black bg-gradient-to-r from-purple-400 to-pink-400 text-transparent bg-clip-text">
                  Coming
                </div>
                <div className={`text-xs sm:text-sm text-gray-500 transition-colors duration-300`}>Spring 2026</div>
              </div>
            </div>
          </div>
          ...
          <div className="hidden lg:grid grid-cols-2 gap-4 lg:gap-6">
            <div className="space-y-4 lg:space-y-6">
              <div className="relative h-64 lg:h-80 rounded-2xl overflow-hidden group">
                ...
                />
                <div className={`absolute inset-0 bg-gradient-to-t from-purple-600/40 to-transparent transition-colors duration-300`}></div>
              </div>
              <div className="relative h-48 lg:h-56 rounded-2xl overflow-hidden group">
                <ImageWithFallback
                  ...
                  className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"
                />
                <div className={`absolute inset-0 bg-gradient-to-t from-pink-600/40 to-transparent transition-colors duration-300`}></div>
              </div>
            </div>
            <div className="space-y-4 lg:space-y-6 pt-12">
              <div className="relative h-48 lg:h-56 rounded-2xl overflow-hidden group">
                <ImageWithFallback
                  ...
                  className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"
                />
                <div className={`absolute inset-0 bg-gradient-to-t from-cyan-600/40 to-transparent transition-colors duration-300`}></div>
              </div>
              <div className="relative h-64 lg:h-80 rounded-2xl overflow-hidden group">
                <ImageWithFallback
      ...
      <section className="relative h-64 sm:h-80 lg:h-[500px] w-full overflow-hidden">
        ...
        />
        <div className={`absolute inset-0 bg-gradient-to-r from-purple-800/70 to-pink-800/70 flex items-center justify-center transition-colors duration-300`}>
          <div className="text-center space-y-3 sm:space-y-4 px-4 sm:px-6">
            ...
            <p className={`text-sm sm:text-lg lg:text-xl text-gray-100 max-w-2xl mx-auto transition-colors duration-300`}>
      ...
      <section id="features" className="py-12 sm:py-16 lg:py-24 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10 sm:mb-16">
            ...
            <p className={`text-base sm:text-lg lg:text-xl text-gray-600 transition-colors duration-300`}>Everything you need to become the fashion icon you are</p>
          </div>

          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {/* Feature 1 */}
            <div className={`group relative bg-white border-gray-200 hover:bg-gray-50 border rounded-3xl p-6 sm:p-8 transition-all duration-300`}>
              ...
              <p className={`text-sm sm:text-base text-gray-600 leading-relaxed transition-colors duration-300`}>
            ...
            {/* Feature 3 */}
            <div className={`group relative bg-white border-gray-200 hover:bg-gray-50 border rounded-3xl p-6 sm:p-8 transition-all duration-300 sm:col-span-2 lg:col-span-1`}>
              <div className="absolute -top-6 left-6 sm:left-8">
      ...
      <section id="about" className="py-12 sm:py-16 lg:py-24 relative">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center space-y-4 sm:space-y-6">
          <div className={`inline-block px-3 sm:px-4 py-2 bg-gradient-to-r from-purple-100 to-pink-100 border-purple-300 rounded-full text-xs sm:text-sm border transition-colors duration-300`}>
            💜 Why REVE?
          </div>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black">
            More than just borrowing clothes
          </h2>
          <p className={`text-sm sm:text-base lg:text-xl text-gray-600 leading-relaxed transition-colors duration-300`}>
          ...
          <div className="grid sm:grid-cols-2 gap-4 sm:gap-6 pt-6 sm:pt-8">
            <div className='bg-white border-gray-200 border rounded-2xl p-5 sm:p-6 text-left transition-all duration-300'>
              ...
              <div className='text-gray-600 text-xs sm:text-sm transition-colors duration-300'>
      ...
      <section className="py-12 sm:py-16 lg:py-24 relative">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center space-y-6 sm:space-y-8">
          ...
          <p className={`text-base sm:text-lg lg:text-xl text-gray-600 transition-colors duration-300`}>
      ...
      {/* Footer */}
      <footer className='border-gray-200 border-t py-8 sm:py-12 transition-colors duration-300'>
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 sm:gap-6">
            ...
            <div className="flex gap-4 sm:gap-6">
              <a href="#" className={`w-10 h-10 bg-gray-100 border-gray-200 hover:bg-gray-200 border rounded-full flex items-center justify-center transition-colors`}>
