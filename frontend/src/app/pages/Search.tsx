import { Home, Search as SearchIcon, Sparkles, MessageCircle, User } from 'lucide-react';
      ...
      <div className="relative z-10 flex items-center justify-center min-h-[calc(100vh-80px)]">
        <div className="text-center">
          <div className="w-24 h-24 mx-auto mb-6 rounded-full bg-gradient-to-br from-[#ff00ff] to-[#9d00ff] flex items-center justify-center">
            <SearchIcon size={48} className="text-white" />
          </div>
          <h1 className="text-3xl font-black text-white mb-3">Search Page</h1>
          <p className="text-white/60 mb-6">Advanced search coming soon</p>
          <button
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-[#1a1a24]/95 backdrop-blur-lg border-t border-white/10 z-50">
        <div className="max-w-screen-xl mx-auto px-6">
          <div className="flex items-center justify-around h-16">
            ...
            <button onClick={() => navigate('/search')} className="flex flex-col items-center gap-1 text-[#ff00ff]">
              <SearchIcon size={24} />
